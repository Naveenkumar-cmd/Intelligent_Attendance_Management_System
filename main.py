...
def check_haarcascadefile():
    exists=os.path.dirname(cv2.__file__)+"/data/haarcascade_frontalface_default.xml"
...
def TakeImages():
    ...
    if ((name.isalpha()) or (' ' in name)):
        ...
        harcascadePath = os.path.dirname(cv2.__file__)+"/data/haarcascade_frontalface_default.xml"
